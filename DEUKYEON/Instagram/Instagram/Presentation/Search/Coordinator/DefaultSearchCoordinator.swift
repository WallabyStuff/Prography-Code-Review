...
protocol SearchCoordinator: MovieDetailCoordinator, LabelPopUpCoordinator {}
...
final class DefaultSearchCoordinator: BaseCoordinator, SearchCoordinator {
  ...
  private func showMovieSearch() {
    ...
    vc.viewModel = MovieSearchViewModel(coordinator: self,
  ...
  func showLabelPopUp() {
    guard let pvc = self.navigationController.viewControllers.last as? MovieSearchViewController else {
      return
    }
